...
import com.apps.ssdco.ecommerce.Model.Cart;
import com.apps.ssdco.ecommerce.Prevalent.Prevalent;
import com.apps.ssdco.ecommerce.ViewHolder.CartViewHolder;
...
public class CartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartListRef = FirebaseDatabase.getInstance(Prevalent.URL).getReference().child("Cart List");
