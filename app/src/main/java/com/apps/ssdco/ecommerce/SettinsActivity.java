...
public class SettinsActivity extends AppCompatActivity
{
    ...
    {
        DatabaseReference ref = FirebaseDatabase.getInstance(Prevalent.URL).getReference().child("Users");
    ...
    {
        DatabaseReference UsersRef = FirebaseDatabase.getInstance(Prevalent.URL).getReference().child("Users").child(Prevalent.currentOnlineUser.getPhone());
